    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body mt-3">
                <form action="{{ route('products.store') }}" class="row gy-3 needs-validation" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nama Produk">
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
